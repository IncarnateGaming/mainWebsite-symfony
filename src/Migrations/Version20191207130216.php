 ...
 */
final class Version20191207130216 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE incarnate_background (id INT NOT NULL, featurefid VARCHAR(16) DEFAULT NULL, gp INT NOT NULL, languages LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', skill_prof LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', start_eq LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', tool_prof LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', personalityfid VARCHAR(16) NOT NULL, idealfid VARCHAR(16) NOT NULL, bondfid VARCHAR(16) NOT NULL, flawfid VARCHAR(16) NOT NULL, suggested_char_intro LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE incarnate_class (id INT NOT NULL, class_ammendment LONGTEXT DEFAULT NULL, archetype LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', equipment LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', hitpoints LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', multiclass LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', proficiencies LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', leveltable LONGTEXT NOT NULL, trait LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', darkvision INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE incarnate_equipment (id INT NOT NULL, gmonly TINYINT(1) NOT NULL, magical TINYINT(1) NOT NULL, mundane TINYINT(1) NOT NULL, ac LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', carryingcapacity VARCHAR(255) DEFAULT NULL, holdingcapacity VARCHAR(255) DEFAULT NULL, cost VARCHAR(255) NOT NULL, cost_sortable DOUBLE PRECISION NOT NULL, damage LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', recommendedlevel INT DEFAULT NULL, consumable TINYINT(1) DEFAULT NULL, offensebonus INT DEFAULT NULL, properties LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', itemrange VARCHAR(255) DEFAULT NULL, rarity VARCHAR(255) DEFAULT NULL, speed VARCHAR(255) DEFAULT NULL, stealth VARCHAR(255) DEFAULT NULL, strengthrequirement VARCHAR(255) DEFAULT NULL, subtype VARCHAR(255) DEFAULT NULL, weight DOUBLE PRECISION DEFAULT NULL, equipment_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
